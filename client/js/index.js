...
function getJournals ()
{
    ...
    return fetch("https://nojudgies.herokuapp.com/allJournals")
        .then( (resp) => resp.json())
        .then( (jData) => 
        {
            return jData;
...
function getComments ()
{
    ...
    return fetch("https://nojudgies.herokuapp.com/allComments")
        .then( (resp) => resp.json())
        .then( (cData) => 
        {
            return cData;
...
{
    //Return promise to originating function, get the comments data then return it 
    return fetch("https://nojudgies.herokuapp.com/byJournalId/"+jId)
        .then((resp) => resp.json())
        .then( (cdata) =>
        {
            return cdata;
...
function addCommentToJournal(jrnlid)
{
    ...
    else
    {
         ...
         //POST the Comment
        fetch("httphttps://nojudgies.herokuapp.com/newComment", 
        {
            method: "POST",
            headers: { 'Content-Type' : 'application/Json'},
            body:   JSON.stringify({
...
{
    fetch("https://nojudgies.herokuapp.com/journal/update/"+jId,
    {
    method: "PATCH",
    headers: { 'Content-Type' : 'application/Json'},
    body:   JSON.stringify({
...
{
    fetch("https://nojudgies.herokuapp.com/comment/update/"+cId,
    {
    method: "PATCH",
    headers: { 'Content-Type' : 'application/Json'},
    body:   JSON.stringify({
